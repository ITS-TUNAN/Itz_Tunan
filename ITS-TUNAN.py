...
III TTTTTT  SSS      TTTTTT U   U N   N  AA  N   N 
 I    TT   S           TT   U   U NN  N A  A NN  N 
 I    TT    SSS        TT   U   U N N N AAAA N N N 
 I    TT       S       TT   U   U N  NN A  A N  NN 
III   TT   SSSS        TT    UUU  N   N A  A N   N 
                                                   
                                             
ITS NOT A NAME, ITS BRAND
______________________________________________________

 [*] DEVELOPER :ðŸ”¥ Itz TunanðŸ”¥
 [*] FACEBOOK  : Sk. Safiuddin 
 [*] GITHIB    : ITS-TUNAN
 [*] GROUP  : CYBER CALIPHATE TEAM(CCT)
 [*] INSTRAGRAM  : sk_tunan_uddin5
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;95m(4 DAY CP🤦‍♂️)  ' + k + c + user + '  |  ' + pass1                                       
    ...
    jalan("Note : Your Offline account Will Open after 10 days")
    print ''
    print """
    ███
──────────███║ITS-TUNAN║\033[1;95mFb\033[1;97m 
\033[1;95m033[1;97m"""
